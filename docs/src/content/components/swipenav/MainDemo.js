  ...
  <ComponentMainDemo
    ...
    description={
      <div>
        ...
        <CodeInline code="ScrollView" type="element" /> and hides the header on
        scroll down and shows the header on scroll up. You can also pass in a
        custom scroll componnt like a{' '}
        <CodeInline code="FlatList" type="element" /> for more control.
      </div>
    }
    code={code}
    scope={{ View, SwipeNav, Appbar, Card, CardContent, Text }}
  />
);
